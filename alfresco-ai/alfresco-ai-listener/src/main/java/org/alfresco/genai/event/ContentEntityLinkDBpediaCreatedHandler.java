...
/**
 * The {@code ContentEntityLinkDBpediaCreatedHandler} class is a Spring component that extends the {@link AbstractContentTypeHandler}
 * and implements the {@link OnNodeCreatedEventHandler} interface. It is responsible for handling events triggered upon
 * the creation of nodes with a specified content type, focusing on nodes with the "cm:content" type and a specific DBpedia entitylinks aspect.
 *
 * <p>This handler provides a concise event filter definition using a combination of filters to identify relevant node
 * creation events. The filter criteria include the presence of the DBpedia entitylinks aspect and the "cm:content" node type.
 */
@Component
public class ContentEntityLinkDBpediaCreatedHandler extends AbstractContentTypeHandler implements OnNodeCreatedEventHandler {
     ...
     * include the presence of the DBpedia entity links aspect and the "cm:content" node type.
     *
